      ...
      <div class="container">
        ...
        <form action="/problem/{{$problem->id}}" method="POST">
          ...
          <div class="form-group">
            ...
            <textarea rows="2" class="form-control" name="sample_input" placeholder="Enter output format" required> {{$problem->sample_input}} </textarea>
          </div>

          <div class="form-group">
            <label for="sample_output">Sample Output:</label>
            <textarea rows="2" class="form-control" name="sample_output" placeholder="Enter output format" required> {{$problem->sample_output}} </textarea>
          </div>
